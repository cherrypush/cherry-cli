...
const countLoc = (file) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return Buffer.from(yield fs_1.promises.readFile(file))
      .toString()
      .split(/\r\n|\r|\n/)
...
const getFileStats = (file) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    return lang && { lang, loc: yield countLoc(file) }
  })
const run = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    const allFiles = yield git.files()
    const limit = (0, p_limit_1.default)(10)
    const fileStats = yield Promise.all(allFiles.map((file) => limit(() => getFileStats(file))))
    const locByLang = (0, lodash_1.default)(fileStats)
      .compact()
      .groupBy(({ lang }) => lang)
      .mapValues((stats) => lodash_1.default.sumBy(stats, 'loc'))
      .value()
