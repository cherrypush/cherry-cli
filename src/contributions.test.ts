...
describe('buildContributionsPayload', () => {
  it('builds the payload', () => {
    const repository: Repository = { host: Host.Github, owner: 'organization', name: 'project', subdir: 'frontend' }
    ...
    expect(
      ...
      project_name: 'Organization frontend',
      author_name: 'Flavio',
      author_email: 'flavio@email.com',
      commit_sha: '9f09cf1',
      commit_url: 'https://github.com/organization/project/commit/9f09cf1',
